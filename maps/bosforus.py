...
if __name__ == "__main__":
    # bbox = [40.972338, 28.942304, 41.056570, 29.039510]
    ...
    for name, city_col, water_col, roads_col in colour_set[:1]:
        print(f"Doing poster: {name}")

        d = create_drawing(SIZE, SIZE, bg_col=water_col)

        #CITY BOUNDARY
        d = add_areas(bbox, zoom, d, "'admin_level'='2'", color=city_col, name="city")
