...
if __name__ == "__main__":
    ...
    for name, island_col, water_col, roads_col in colour_set:
        ...
        #draw islands
        d = add_areas(bbox, zoom, d, "'place'='archipelago'", color=island_col, name="island")

        #inland water
        d = add_areas(bbox, zoom, d, "'natural'='water'", color=water_col, name="inland_water")
        ...
        d = add_ways(bbox, zoom, d, s, color=roads_col, name="ways", width=0.2)
